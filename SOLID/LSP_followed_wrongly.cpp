...
#include <typeinfo>
#include <stdexcept>
 //Checking account type explicitly using typeid to handle specific behavior for FixedTermAccount, which violates LSP as client code needs to be aware of specific account types and their behaviors, breaking substitutability.
using namespace std;
