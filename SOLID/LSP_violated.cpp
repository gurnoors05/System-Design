...
using namespace std;
//Assuming all accounts support withdrawal but LSP Violation as FixedTermAccount does not support withdrawal
class Account {
public:
...
public:
    ...
    void processTransactions() {
        for (Account* acc : accounts) {
            ...
            //Assuming all accounts support withdrawal (LSP Violation because FixedTermAccount does not support withdrawal)
            try {
                acc->withdraw(500);
